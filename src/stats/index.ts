...
export { clip, dataFrameAbs, dataFrameClip, dataFrameRound, seriesAbs, seriesRound } from "./elem_ops.ts";
export type { ClipOptions, DataFrameElemOptions, RoundOptions } from "./elem_ops.ts";
