/**
 * Benchmark: mergeAsof with direction="forward" — forward asof join of two 10k-row sorted DataFrames.
 * Outputs JSON: {"function": "merge_asof_forward", "mean_ms": ..., "iterations": ..., "total_ms": ...}
 */
